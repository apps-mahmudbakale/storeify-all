...
Route::group(['prefix' => 'app', 'as' => 'app.', 'middleware' => 'auth'], function () {
    ...
    Route::resource('customer-credits', \App\Http\Controllers\CustomerCreditController::class);
    Route::post('customer-credits/{customerCredit}/mark-cleared', [\App\Http\Controllers\CustomerCreditController::class, 'markCleared'])->name('customer-credits.mark-cleared');
